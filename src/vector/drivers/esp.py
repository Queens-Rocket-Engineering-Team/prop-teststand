...
from vector.qlcp.decoding import ServerReceivedPacket, decode_packet_server
from vector.qlcp.native import HEADER_SIZE, MAGIC_NUM_SIZE, find_magic_num, get_packet_len


if TYPE_CHECKING:
    import socket

    from vector.qlcp.packets import QLCPPacket

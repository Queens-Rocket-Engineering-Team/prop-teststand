...
from prop_teststand import config
from prop_teststand.api import fast_api
from prop_teststand.daemons.cli_terminal import command_processor
from prop_teststand.runtime.logging import configure_logging
from prop_teststand.runtime.services import build_runtime
...
async def main() -> None:
    ...
    logger.info("Starting server (version: %s)...", prop_teststand.__version__)
